...
- **NOUVEAU** : Intégration avec Postimages pour l'hébergement d'images sans Firebase Storage
...
- Simplification des formulaires d'ajout d'images pour une meilleure expérience utilisateur
...
- Instructions détaillées pour l'utilisation de Postimages

## Utilisation de Postimages pour les images

Pour ajouter des images à vos articles ou livres sans Firebase Storage, nous recommandons Postimages.org :

1. **Uploader l'image sur Postimages**
   - Accédez à [Postimages.org](https://postimages.org/)
   - Cliquez sur "Choisir une image" (pas besoin de créer un compte)
   - Uploadez votre image
   - Une fois l'image uploadée, copiez le lien "Lien direct"
...
3. **Avantages de Postimages**
   - Service 100% gratuit sans inscription requise
   - Pas de problèmes CORS
   - Liens d'accès direct simples
   - Possibilité de redimensionner les images
   - Conservation des images pendant des années
